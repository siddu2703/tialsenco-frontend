  ...
  return (
    <>
      <Element
        leftSide={
          <PropertyCheckbox
            propertyKey="vendor_number_pattern"
      ...
      >
        <InputField
          ...
          onValueChange={(value) =>
            handleChange('settings.vendor_number_pattern', value)
          }
          disabled={disableSettingsField('vendor_number_pattern')}
      ...
      <Element
        leftSide={
          <PropertyCheckbox
            propertyKey="vendor_number_counter"
