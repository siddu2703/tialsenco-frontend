  ...
  return (
    <>
      <Element
        leftSide={
          <PropertyCheckbox
            propertyKey="payment_number_pattern"
      ...
      >
        <InputField
          ...
          onValueChange={(value) =>
            handleChange('settings.payment_number_pattern', value)
          }
          disabled={disableSettingsField('payment_number_pattern')}
      ...
      <Element
        leftSide={
          <PropertyCheckbox
            propertyKey="payment_number_counter"
