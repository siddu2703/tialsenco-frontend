...
export function AURegions() {
  ...
  const regions: Array<[string, TaxSetting]> = Object.entries(
    companyChanges.tax_data.regions.AU.subregions
  );
            ...
            <SelectField
              ...
              onValueChange={(value) =>
                handleChangeAndUpdateView(
                  'tax_data.regions.AU.tax_all_subregions',
                  value === 'true'
                )
              }
            >
          ...
          >
            ...
            >
              <Checkbox
                ...
                value={`tax_data.regions.AU.subregions.${value[0]}.apply_tax`}
                checked={value[1].apply_tax ? true : false}
                className="flex justify-end h-6 w-6 rounded-half shadow"
                disabled={companyChanges.tax_data.regions.AU.tax_all_subregions}
