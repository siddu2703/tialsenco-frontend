    ...
    <>
      ...
      <Element leftSide={t('status')}>
        <ul className="list-none">
          <li>
            <b>Merchant id:</b> {resolveConfigValue('merchantId')}
          </li>
          <li>
            <b>{t('status')}:</b> {resolveConfigValue('status')}
          </li>
          <li>
            <b>{t('email')}:</b> {resolveConfigValue('emailVerified')}
          </li>
          <li>
            <b>{t('permissions')}:</b> {resolveConfigValue('permissions')}
          </li>
          <li>
            <b>{t('notifications')}:</b> {resolveConfigValue('returnMessage')}
          </li>
        </ul>
      </Element>
      {/* )} */}
