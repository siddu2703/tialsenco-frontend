...
export const purchaseorderMap: Record[] = [
  ...
  {
    trans: 'paid_to_date',
    value: 'purchase_order.paid_to_date',
    map: 'purchase_order',
  },
  {
    trans: 'discount',
  ...
  {
    trans: 'public_notes',
    value: 'purchase_order.public_notes',
    map: 'purchase_order',
  },
  {
    trans: 'private_notes',
    value: 'purchase_order.private_notes',
    map: 'purchase_order',
  },
  {
  ...
  },
  {
    ...
    value: 'purchase_order.is_amount_discount',
    map: 'purchase_order',
  },
  ...
  {
    trans: 'surcharge2',
    value: 'purchase_order.custom_surcharge2',
    map: 'purchase_order',
  },
  {
    trans: 'surcharge3',
    value: 'purchase_order.custom_surcharge3',
    map: 'purchase_order',
  },
  {
    trans: 'surcharge4',
    value: 'purchase_order.custom_surcharge4',
    map: 'purchase_order',
  },
  {
    trans: 'exchange_rate',
    value: 'purchase_order.exchange_rate',
    map: 'purchase_order',
  },
  {
    trans: 'tax_amount',
    value: 'purchase_order.total_taxes',
    map: 'purchase_order',
  },
  {
    trans: 'assigned_user',
    value: 'purchase_order.assigned_user_id',
    map: 'purchase_order',
  },
  { trans: 'user', value: 'purchase_order.user_id', map: 'purchase_order' },
  {
    trans: 'tax_name1',
    value: 'purchase_order.tax_name1',
    map: 'purchase_order',
  },
  {
    trans: 'tax_rate1',
    value: 'purchase_order.tax_rate1',
    map: 'purchase_order',
  },
  {
    trans: 'tax_name2',
    value: 'purchase_order.tax_name2',
    map: 'purchase_order',
  },
  {
    trans: 'tax_rate2',
    value: 'purchase_order.tax_rate2',
    map: 'purchase_order',
  },
  {
    trans: 'tax_name3',
    value: 'purchase_order.tax_name3',
    map: 'purchase_order',
  },
  {
    trans: 'tax_rate3',
    value: 'purchase_order.tax_rate3',
    map: 'purchase_order',
  },
];
