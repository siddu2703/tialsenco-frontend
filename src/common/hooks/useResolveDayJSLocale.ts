...
export function useResolveDayJSLocale() {
  return (appLanguage: string) => {
    const languageKey = appLanguage.replace('_', '-').toLowerCase();
    ...
    switch (languageKey) {
      ...
      case 'en-il':
        return import('dayjs/locale/en-il');
      case 'en-in':
      ...
      case 'x-pseudo':
        return import('dayjs/locale/x-pseudo');
      case 'yo':
